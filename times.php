...
$query = "SELECT nome, pontuacao FROM times";
      ...
      <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
          <div class="sidebar-brand">
            <a href="user.php">Tabela do Brasileirão</a>
        ...
        <div class="sidebar-footer" style="">
          <a href="logout.php">
            <i class="fa fa-power-off"></i><span class="badge-sonar"></span>
            <!--sair da sessao- -->
          </a>
        </div>
      </nav>
              ...
              <div class="panel panel">
                <div class="panel-heading" style="background-color: #363636;">
                  <h3 class="panel-title">
                    <font color="#F0FFFF"> Brasileirão</font>
                  </h3>
                </div>
                <table class="table table-striped table-bordered" id="myTable">
                  <thead>
                    ...
                    <th>
                      <font color="black">Pontuação </font>
                    </th>
                  </thead>
                  <tbody>
                    ...
                    while ($res = mysqli_fetch_assoc($q)) {
                      echo '<tr>';
                      echo '<td><img src="imagens/' . $res['nome'] . '.png">' . " " . ucfirst($res['nome']) . "</td>";
