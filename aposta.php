      ...
      <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
          <div class="sidebar-brand">
            <a href="#">Tabela do Brasileirão</a>
          ...
          <div class="sidebar-header">
            <div class="user-pic">
              <img class="img-thumbnail" style="width: 100px; height: 50px;" src="https://raw.githubusercontent.com/azouaoui-med/pro-sidebar-template/gh-pages/src/img/user.jpg" alt="User picture">
            </div>
            <div class="user-info">
              <span class="user-name"><?php session_start();
                                      echo $_SESSION['user']; ?>
              ...
              <li>
                <a href="user_list.php">
                  ...
                  <span class="badge badge-pill badge-danger">
                    <!--Aq da pra colocar um numero indicando qtd de algo -->
                  </span>
                </a>
              </li>
              <li class="sidebar-dropdown">
        ...
        <div class="sidebar-footer" style="">
          ...
          <a href="#">
            ...
            <!--Coloca um link pra config pro perfil do individuo -->
          </a>
          <a href="#">
          ...
          <div class="row">
              ...
              <div class="panel panel">
                <div class="panel-heading" style="background-color: #363636;">
                  <h3 class="panel-title">
                    <font color="#F0FFFF"> HaironChamp</font>
                  </h3>
            ...
            <div class="col-sm-6">
              <div class="panel panel">
                <div class="panel-heading" style="background-color: #363636;">
                  <h3 class="panel-title">
                    <font color="#F0FFFF"> Pontuação</font>
                  </h3>
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered" id="myTable">
                    <thead>
                      <th>
                        <font color="black">Pontuacao </font>
                      </th>
